...
const One = TabComp(
  ...
  'Visualiza',
  'Monitorea en tiempo real el flujo de camiones del SM1 de la CDMX'
);
const Two = TabComp(
  require('../assests/img/img_2.png'),
  'Planifica',
  'Localiza las próximas unidades que llegarán a tu parada'
);
const Three = TabComp(
  require('../assests/img/img_3.png'),
  'Proyecta',
  'Recibe el tiempo estimado en el que tu unidad llegará a las próximas paradas'
);
